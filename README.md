...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/lbplatformutils-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7540&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/lbplatformutils-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `lbplatformutils` can be installed with:

```
conda install lbplatformutils
```

It is possible to list all of the versions of `lbplatformutils` available on your platform with:
